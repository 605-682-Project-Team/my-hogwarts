...
<div class="jumbotron">
    <h2 class="display-4"><%= course.getName() %>
    </h2>
    <p><b>Professor: </b> <%= course.getProfessor() %>
    </p>
    <p><b>Category: </b> <%= course.getCategory() %>
    </p>
    <p class="lead"><%= course.getDescription() %>
    </p>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td class="align-middle"><a
                    href="<%= request.getContextPath() %>/restricted/course-material-listing/<%= courseMaterial.getId() %>"><%= courseMaterial.getName() %>
            </a></td>
