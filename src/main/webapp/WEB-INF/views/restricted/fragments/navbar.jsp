...
<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <img class="nav-bar-icon" src="<%= request.getContextPath() %>/resources/images/hogwarts-crest.png"> <a
            class="navbar-brand" href="<%= request.getContextPath() %>/restricted/dashboard">MyHogwarts</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a class="nav-link"
                                               href="<%= request.getContextPath() %>/restricted/dashboard">Home <span
                        class="sr-only">(current)</span></a></li>
                <li class="nav-item"><a class="nav-link" href="<%= request.getContextPath() %>/restricted/account">Account</a>
                </li>
                <li class="nav-item"><a class="nav-link"
                                        href="<%= request.getContextPath() %>/restricted/course-listing">Courses</a>
                </li>
                <li class="nav-item"><a class="nav-link"
                                        href="<%= request.getContextPath() %>/restricted/course-material-listing">Course
                    Materials</a></li>
