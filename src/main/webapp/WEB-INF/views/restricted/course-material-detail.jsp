...
<body class="bg-light">
	 ...
	 <div class="jumbotron">
	 	<div class="container">
	 		<div class="row" >
	 			<div class="col-md-9">
  					<h2 class="display-4"><%= courseMaterial.getName() %></h2>
  					<p><b>Price: </b> <%= String.format("$%.2f", courseMaterial.getPrice()) %> </p>
  					<p class="lead"><%= courseMaterial.getDescription() %></p>
  					<br/>
				...
				<div class="col-md-3">
					<img class="material-icon" src="<%= request.getContextPath() %>/resources/images/course-materials/<%= courseMaterial.getImageName() %>" height="300" width="300">
				</div>
			</div>
		</div>
	</div>
