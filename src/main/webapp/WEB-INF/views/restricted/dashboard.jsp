    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="first-slide" src="<%= request.getContextPath() %>/resources/images/hogwarts-castle.jpg"
                     alt="First slide">
                <div class="container">
            ...
            <div class="carousel-item">
                <img class="second-slide" src="<%= request.getContextPath() %>/resources/images/quidditch.jpg"
                     alt="Second slide">
                <div class="container">
            ...
            <div class="carousel-item">
                <img class="third-slide" src="<%= request.getContextPath() %>/resources/images/hall.jpg"
                     alt="Third slide">
                <div class="container">
