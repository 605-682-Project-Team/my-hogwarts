        ...
        <div class="col-md-8">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <form action="<%= request.getContextPath() %>/restricted/shopping-cart/remove-course/<%= course.getId() %>"
                              method="post">
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td class="align-middle">
                <form id="formUpdate<%= courseMaterial.getId() %>"
                      action="<%= request.getContextPath() %>/restricted/shopping-cart/update-course-material/<%= courseMaterial.getId() %>"
                      method="post">
                    <input style="width:2.5em" name="quantity" type="number"
                           value="<%= courseMaterials.get(courseMaterial) %>"/>x<%= String.format("$%.2f", courseMaterial.getPrice()) %>
                </form>
            </td>
            ...
            <td class="align-middle text-right" style="width:13em">
                ...
                <form style="display: inline-block;"
                      action="<%= request.getContextPath() %>/restricted/shopping-cart/remove-course-material/<%= courseMaterial.getId() %>"
                      method="post">
                    <input type="submit" class="btn btn-danger btn-md" value="Remove"/>
                </form>
            </td>
