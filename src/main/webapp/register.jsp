			...
			<form action="user/create" method="post">
				...
				<div class="mb-3">
					<label for="email">Email</label> <input type="email"
						class="form-control" id="email" name="email" placeholder="someone@example.com"
						required>
				</div>
				<div class="row">
					<div class="col-md-6 mb-3">
				...
				<div class="mb-3">
					<label for="streetAddress">Address</label> <input type="text"
						class="form-control" id="streetAddress" name="streetAddress" required>
				</div>
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						<label for="zipcode">Zipcode</label> <input type="text"
							class="form-control" id="zipcode" name="zipcode" maxlength="5" minlength="5"
							required>
					</div>
				</div>
				<hr class="mb-4">
